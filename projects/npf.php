...
function npfProj () {
	...
	$summary ='Responsive website built in Drupal, along with custom Donation form utilizing Luminate API.';
	$cat = 'Responsive Development, Fundraising Solutions';
	$role = 'Lead Developer';
	$overview = "New responsive website built in Drupal, along with custom Donation form utilizing Luminate API.";
	$catlength = count($cat);
